...
### [12] [When Consistency Becomes Bias: Interviewer Effects in Semi-Structured Clinical Interviews](https://arxiv.org/abs/2603.24651)
...
### [13] [Demystifying When Pruning Works via Representation Hierarchies](https://arxiv.org/abs/2603.24652)
...
### [14] [Fine-Tuning A Large Language Model for Systematic Review Screening](https://arxiv.org/abs/2603.24767)
...
### [15] [Evaluating Fine-Tuned LLM Model For Medical Transcription With Small Low-Resource Languages Validated Dataset](https://arxiv.org/abs/2603.24772)
...
### [16] [Enhancing Structured Meaning Representations with Aspect Classification](https://arxiv.org/abs/2603.24797)
...
### [17] [Synthetic Rewriting as a Quality Multiplier: Evidence from Portuguese Continued Pretraining](https://arxiv.org/abs/2603.24826)
...
### [18] [Prune as You Generate: Online Rollout Pruning for Faster and Better RLVR](https://arxiv.org/abs/2603.24840)
...
### [19] [LogSigma at SemEval-2026 Task 3: Uncertainty-Weighted Multitask Learning for Dimensional Aspect-Based Sentiment Analysis](https://arxiv.org/abs/2603.24896)
...
### [20] [Estimating near-verbatim extraction risk in language models with decoding-constrained beam search](https://arxiv.org/abs/2603.24917)
...
### [21] [Toward domain-specific machine translation and quality estimation systems](https://arxiv.org/abs/2603.24955)
...
### [22] [LLM-Driven Reasoning for Constraint-Aware Feature Selection in Industrial Systems](https://arxiv.org/abs/2603.24979)
...
### [28] [A Gait Foundation Model Predicts Multi-System Health Phenotypes from 3D Skeletal Motion](https://arxiv.org/abs/2603.25283)
...
### [34] [Permeation of hydrogen across graphdiyne: molecular dynamics vs. quantum simulations and role of membrane motion](https://arxiv.org/abs/2603.24827)
...
### [35] [Implementation of the multigrid Gaussian-Plane-Wave algorithm with GPU acceleration in PySCF](https://arxiv.org/abs/2603.24881)
...
### [36] [A sustainable photocatalytic pathway for concurrent hydrogen and value-added chemical production utilizing microalgae as bio-scavenger in water](https://arxiv.org/abs/2603.24924)
...
### [37] [Deep learning of committor and explainable artificial intelligence analysis for identifying reaction coordinates](https://arxiv.org/abs/2603.25237)
...
### [38] [Complementary Eigen-Zundel Interpretation Reconciles Thermodynamics and Spectroscopy of Excess Protons in Aqueous HF Solutions](https://arxiv.org/abs/2603.25371)
...
### [39] [Enabling ab initio geometry optimization of strongly correlated systems with transferable deep quantum Monte Carlo](https://arxiv.org/abs/2603.25381)
...
### [40] [Automating Computational Chemistry Workflows via OpenClaw and Domain-Specific Skills](https://arxiv.org/abs/2603.25522)
...
### [41] [DyMRL: Dynamic Multispace Representation Learning for Multimodal Event Forecasting in Knowledge Graph](https://arxiv.org/abs/2603.24636)
...
### [42] [How unconstrained machine-learning models learn physical symmetries](https://arxiv.org/abs/2603.24638)
...
### [44] [Learning Mesh-Free Discrete Differential Operators with Self-Supervised Graph Neural Networks](https://arxiv.org/abs/2603.24641)
...
### [45] [Physics-Informed Neural Network Digital Twin for Dynamic Tray-Wise Modeling of Distillation Columns under Transient Operating Conditions](https://arxiv.org/abs/2603.24644)
...
### [46] [Can LLMs Beat Classical Hyperparameter Optimization Algorithms? A Study on autoresearch](https://arxiv.org/abs/2603.24647)
...
### [47] [Once-for-All Channel Mixers (HYPERTINYPW): Generative Compression for TinyML](https://arxiv.org/abs/2603.24916)
*Yassien Shaalan*
...
### [48] [Energy-Efficient Hierarchical Federated Anomaly Detection for the Internet of Underwater Things via Selective Cooperative Aggregation](https://arxiv.org/abs/2603.24648)
...
### [49] [The Order Is The Message](https://arxiv.org/abs/2603.25047)
*Jordan LeDoux*
...
### [50] [Amplified Patch-Level Differential Privacy for Free via Random Cropping](https://arxiv.org/abs/2603.24695)
...
### [51] [Vision Hopfield Memory Networks](https://arxiv.org/abs/2603.25157)
...
### [54] [Contrastive Learning Boosts Deterministic and Generative Models for Weather Data](https://arxiv.org/abs/2603.24744)
*Nathan Bailey*
...
### [55] [Improving Infinitely Deep Bayesian Neural Networks with Nesterov's Accelerated Gradient Method](https://arxiv.org/abs/2603.25024)
...
### [56] [Fair regression under localized demographic parity constraints](https://arxiv.org/abs/2603.25224)
...
### [57] [Practical Efficient Global Optimization is No-regret](https://arxiv.org/abs/2603.25311)
...
### [58] [A Distribution-to-Distribution Neural Probabilistic Forecasting Framework for Dynamical Systems](https://arxiv.org/abs/2603.25370)
...
### [59] [Adaptive Subspace Modeling With Functional Tucker Decomposition](https://arxiv.org/abs/2603.25530)
...
### [60] [The Rules-and-Facts Model for Simultaneous Generalization and Memorization in Neural Networks](https://arxiv.org/abs/2603.25579)
...
### [61] [Learning relationships in epidemiological data using graph neural networks](https://arxiv.org/abs/2603.24745)
...
### [62] [Lingshu-Cell: A generative cellular world model for transcriptome modeling toward virtual cells](https://arxiv.org/abs/2603.25240)
...
### [63] [Chalcogen Doping Effect on the Insulator-to-Metal Transition in GdPS](https://arxiv.org/abs/2603.24762)
...
### [64] [Concerted Electron-Ion Transport by Polyacrylonitrile Elucidated with Reactive Deep Learning Potentials](https://arxiv.org/abs/2603.24798)
...
### [65] [Suppression of Metallic Transport in Nitrogen-rich Two-Dimensional Transition Metal Nitrides](https://arxiv.org/abs/2603.24873)
...
### [66] [The ground state of CuInP$_2$S$_6$ thin films: A study of the deep potential method](https://arxiv.org/abs/2603.24901)
...
### [67] [Forster energy transfer boosts indirect anisotropic interlayer excitons in 2L-MoSe2/perovskite heterostructures](https://arxiv.org/abs/2603.24928)
...
### [68] [Dual migration modes of unfaulted disconnections on curved twin boundaries](https://arxiv.org/abs/2603.24987)
...
### [69] [Effect of Pb doping on the crystallization process and thermoelectric properties of Ge2Sb2Te5 phase change material](https://arxiv.org/abs/2603.25123)
...
### [70] [Distinguishing apparent and hidden altermagnetism via uniaxial strain in $\mathrm{CsV_2Te_2O}$-family](https://arxiv.org/abs/2603.25136)
